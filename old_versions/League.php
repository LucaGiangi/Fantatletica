...
<div class="body_info">
    ...
    <!-- ********************* -->
     ...
     <div class="col_sx">
      ...
      <?php 
	    $cont=0;
		$q="SELECT * FROM Competizione where Termine_formazione>='".$data."' order by Data_inizio LIMIT 0,3";
...
Il budget a disposizione è di: '.$r->Budget.'.</articolo><br>';
      ...
      <!-- punti -->
       ...
       <div class="col_dx">
		...
		$q="SELECT * FROM Competizione where (Termine_formazione<='".$data."' and Data_fine + INTERVAL 3 DAY>='".$data_1."') order by Data_inizio LIMIT 0,3";
		$t=mysql_query($q,$connessione); 	
		while($r=mysql_fetch_object($t)){ 
			$nome_comp=$r->Nome;
			   print'
		...
		if ($cont==0){/* non ci sono gare in corso quindi stampo quelle passate */
			$q="SELECT * FROM Competizione where (Data_fine <='".$data_1."' and Stato_classifica='Ufficiale') order by Data_fine desc  LIMIT 0,1";
      ...
      <div class="col_dx">
      	...
      	<!-- classifica -->
       <!--    <div class="col_dx">
           		<div class="titolo"><hh2>Classifica generale</hh2></div>
                <p>
                &nbsp;Non ancora disponibile</p>-->
               
          <!--      <table class="tab_el"> 
                    <tbody><tr><th width="10%">Avatar</th><th width="7%">Posizione</th><th width="45%">Giocatore</th><th width="8%">Punti</th></tr></tbody>

<tr><td><img  width="50" src="images/profilo.jpg"></td><td>1</td><td>nome cognome</td><td>120</td></tr>
<tr><td><img width="50" src="images/profilo.jpg"></td><td>1</td><td>nome cognome</td><td>120</td></tr>
<tr><td><img width="50" src="images/profilo.jpg"></td><td>1</td><td>nome cognome</td><td>120</td></tr>
<tr><td><img width="50" src="images/profilo.jpg"></td><td>1</td><td>nome cognome</td><td>120</td></tr>
<tr><td><img width="50" src="images/profilo.jpg"></td><td>1</td><td>nome cognome</td><td>120</td></tr>
