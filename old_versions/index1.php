...
<div class="call_action" style="margin-top:50px;" >
    ...
    <p>&nbsp;</p><p>&nbsp;</p>
          ...
          <?php if (isset($_COOKIE[$C_token])) print'<a href="g-home.php">'; else print'<a href="login.php">'; ?><img src="images/gioca-ora1.png"/></a>
                </div>
                <p>&nbsp;</p>
        	</div>
        </div>
...
<div class="body_info">
	<div class="call_action_contenuto">
     ...
     <h2><img src="images/fanta.png" ></h2>
        <h2>Fantatletica</h2>
...
//print '<div class="button_home" >GIOCA ORA</div></a>'; ?>
           ...
           <div class="tre_articoli">
             <h2><img src="images/schedina.png" ></h2>
        <h2>Schedina</h2>
...
<?php //if (isset($_COOKIE[$C_token])) print'<a href="Schedina.php">'; else print'<a href="login.php?refer='.$_GET['refer'].'">';
 //print'<div class="button_home" >GIOCA ORA</div></a>'; ?>
           ...
           <a href="Hall_of_fame.php"><div class="tre_articoli" >
           
         
           <h2 ><img src="images/eb469c.png"/></h2>
           
           
        <h2>Hall of fame</h2>
         
      <span class="articolo">      
I vincitori di ogni tappa del Fantatletica e della schedina avranno l'onore di vedere il proprio nome in questa sezione. Prova a lasciare il segno nella Hall of Fame!</span>
<br>
...
<div class="body_info" style="background:#F3AA05;">
    ...
    <div style="width:100%; text-align:center; color:#fff; font-size:28px; margin-top:10px;   margin-bottom: 10px;" >
    	<p>Atleti piu giocati</p>
        <img src="images/header_gare/EuropeiU23Tallin.png" />
    </div>
		...
		<div class="rank1">
       		<div class="croppera didascalia">
				<img src="images/Atleti/Alessia Trost.JPG" title="Alessia Trost"  />
                <span><articolo>Alessia Trost <br/> 30 giocatori</articolo></span>  
			</div>
		</div>
        
        <div class="rank2">
        	<div class="cropperb didascalia">
				<img src="images/Atleti/Lorenzo Perini.JPG" title="Lorenzo Perini"  />
                <span><articolo> Lorenzo Perini <br/> 22 giocatori </articolo></span>  
			</div>  
  <!--  <div class="at_name"><span><strong>  Lorenzo Perini</strong> <br/> 22 giocatori</span></div>-->     
        </div>
        
        <div class="rank3" >
       		<div class="cropperc didascalia">
				<img src="images/Atleti/Dariya Derkach.JPG" title="Dariya Derkach" />
                <span><articolo> Dariya Derkach <br/> 16 giocatori</articolo> </span>  
			</div>
        </div>
