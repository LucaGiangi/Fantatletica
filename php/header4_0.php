<?php if ($page_name=="index" or $page_name=="regolamento" or $page_name=="profile") if ($page_name=="profile") print '<body class="body_sfondo1">'; else print'<body>'; else print'<body class="body_sfondo">';
...
<div id="content" class="snap-content">
	<div id="head">
		<?php //print'<a href="#" id="open-left" ></a>'; ?><a href="index.php"><h1>fantatletica</h1></a><?php /*<a href="#" id="open-right"></a> */ ?>
    </div>
