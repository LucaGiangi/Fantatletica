<?php if ($page_name=="index" or $page_name=="regolamento" or $page_name=="profile") if ($page_name=="profile" || $page_name=="leagues") print '<body class="body_sfondo1">'; else print'<body>'; else print'<body class="body_sfondo">';
...
<div id="content" class="snap-content">
	<div id="head">
		<?php //print'<a href="#" id="open-left" ></a>'; ?>
    ...
    <div id="mainmenu" class="">
       ...
       <a href="index.php"><h1>Fantatletica</h1></a><?php /*<a href="#" id="open-right"></a> */ ?>
    </div>

<?php
//if ($page_name=="profile") print '<div class="header_utente"><div class="copertina"> </div>';
if ($page_name!="index" and $page_name!="OpenSchedina"  and $page_name!="profile" ){ print'
	<div id="toolbar">
		<div id="menu" >
