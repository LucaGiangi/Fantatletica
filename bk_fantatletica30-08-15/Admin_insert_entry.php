        ...
        <form action="Admin_insert_entry.php" method="post">
            <table width="60%">
                <tr>
                    ...
                    <td><label>Sesso</label><select name="sesso"><option value="M">M</option><option value="F">F</option></select></td>
                    <td><input type="button" onClick="Read(1);" value="Leggi" name="Leggi" /><input type="submit" value="Converti" name="Converti" /></td>
				</tr>
            	<tr>
                ...
                <tr>
                	<td colspan="5"><textarea id="iscritti" style="width:100%;height:500px;background:#F3AA05;" name="lista"></textarea></td>                
                </tr>         
            </table>
...
xmlhttp.open("GET","Ajax/Read_utenti.php?id="+id+"cod="+cod,true);
xmlhttp.send(null);
}
</script>